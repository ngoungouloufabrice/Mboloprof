...
const MENU_ITEMS = [
    { text: 'Vue d\'ensemble', icon: <DashboardIcon />, path: '/admindashboard' },
    { text: 'Professeurs', icon: <SchoolIcon />, path: '/admindashboard/teachers' },
    { text: 'Etudiants', icon: <PersonIcon />, path: '/admindashboard/students' },
    { text: 'Annonces', icon: <AdsIcon />, path: '/admindashboard/ads' },
    { text: 'Mon Profil', icon: <ProfileIcon />, path: '/admindashboard/profile' },
];
