...
export default function StudentsPage() {
    ...
    return (
        <Box>
            {success && (
                <Box className="mb-10 flex items-center justify-between">
                    <Typography variant="h4" className="text-3xl font-black text-[#111827] mb-2">
                        Eleve/Etudiant supprimée avec succès
                    </Typography>
                </Box>
            )}
            <Box className="mb-10 flex items-center justify-between">
                <Box>
                    <Typography variant="h4" className="text-3xl font-black text-[#111827] mb-2">
                        Toutes les Eleves/Etudiants
                    </Typography>
                    <Typography className="text-gray-500 font-medium">
                        Gérez les Eleves/Etudiants.
                    </Typography>
                </Box>
            </Box>
            ...
            {loading ? (
                ...
                <Box className="space-y-4">
                    ...
                    {students.map((student) => (
                        <Paper key={student._id} elevation={0} className="p-6 md:p-8 rounded-[24px] border border-gray-100 shadow-sm hover:shadow-md transition-all">
            ...
            >
                <DialogTitle className="font-black text-xl text-center">Supprimer l'élève/étudiant ?</DialogTitle>
                <DialogContent>
                    <Typography className="text-gray-500 text-center font-medium">
                        Cette action est irréversible. Toutes les données associées à cette élève/étudiant seront supprimées.
                    </Typography>
                </DialogContent>
