        ...
        <Box>
            <Box className="mb-10">
                ...
                <Typography className="text-gray-500 font-medium">
                    Gérez vos informations personnelles et professionnelles pour attirer plus d'étudiants.
                </Typography>
            </Box>
                ...
                <Box className="flex flex-col gap-8">
                    ...
                    <Paper elevation={0} className="p-8 rounded-[32px] border border-gray-100 shadow-xl shadow-blue-50/50">
                        <Box className="flex flex-col md:flex-row items-center gap-8 text-center md:text-left">
                            ...
                            <Box className="flex-1">
                                ...
                                <Typography className="text-gray-400 font-bold mb-4">
                                    Professeur de {user?.role === 'PROF' ? 'Tutorat' : ''}
                                </Typography>
                    ...
                    <Paper elevation={0} className="p-8 md:p-10 rounded-[32px] border border-gray-100 shadow-xl shadow-blue-50/50">
                        <Box className="space-y-8">
                            ...
                            <Box>
                                <label className="block text-[13px] font-bold text-[#111827] mb-2 ml-1">Expérience professionnelle</label>
                                <TextField
                                    fullWidth
                                    multiline
                                    rows={3}
                                    name="experience"
                                    placeholder="Ex: 5 ans d'enseignement au Lycée d'Application, Docteur en Mathématiques..."
                            ...
                            <Box>
                                <label className="block text-[13px] font-bold text-[#111827] mb-2 ml-1">À propos de moi</label>
                                <TextField
                                    fullWidth
                                    multiline
                                    rows={6}
                                    name="about"
                                    placeholder="Présentez votre méthodologie et votre passion pour l'enseignement..."
